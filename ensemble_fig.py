...
texts_train, texts_test, labels_train, labels_test, idioms_train, idioms_test, metaphors_train, metaphors_test, hyperboles_train, hyperboles_test = load_and_split_data("FINAL_empathy_dataset_figurative.csv", test_size=0.2)
...
model_roberta_twitter = AutoModelForSequenceClassification.from_pretrained('/content/drive/My Drive/roberta_twitter_fig')
model_roberta_large_mnli = AutoModelForSequenceClassification.from_pretrained('/content/drive/My Drive/roberta_large_fig')
model_t5 = AutoModelForSequenceClassification.from_pretrained('/content/drive/My Drive/t5_fig')
...
def get_model_predictions(model, dataloader):
    ...
    with torch.no_grad():
        for batch in dataloader:
            inputs, attention_mask = batch[0], batch[1]
...
# dynamic weighting
# predictions_roberta_twitter, predictions_roberta_large_mnli, predictions_t5
